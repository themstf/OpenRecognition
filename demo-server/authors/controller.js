...
controller.get_add = (req, res) => {
    console.log("-- GET /add --");
    res.send('put a new author\'s name in the body and send a post request to this address: { first_name: "string" }. you\'ll get back the new author\'s id');
}
...
/* ------------------- READ -------------------*/
// GET  "/find/:id"             => View authors Info with id ...
